              ...
              <div class="panel panel-default sidebar-menu">
                ...
                <div class="panel-body">
                  <ul class="nav nav-pills flex-column text-sm">
                    <li class="nav-item"><a href="text.html" class="nav-link">Trips</a></li>
                    <li class="nav-item"><a href="contact.html" class="nav-link">Meetings</a></li>
                    <li class="nav-item"><a href="faq.html" class="nav-link">Other Events</a></li>
                  </ul>
                </div>
                <br>
